  ...
  return (
    <>
      <FormControl component="fieldset" className={classes.formControl}>
        ...
        <RadioGroup name="vertical" className={classes.group} value={vertical} onChange={onVerticalChange}>
      ...
      <FormControl component="fieldset" className={classes.formControl}>
        ...
        <RadioGroup name="horizontal" className={classes.group} value={horizontal} onChange={onHorizontalChange}>
...
export default PositioningSnackbars;
