...
function MyTypography({ variant, ...props }) {
  return <Typography variant={variant || 'inherit'} {...props} />;
}

function TypesOfTypography() {
  return (
    <Fragment>
      ...
      <Typography variant="h6" component="div">
        ...
        <Typography variant="inherit">another inherited h6 variant</Typography>
