...
const someAPI = searchText =>
  new Promise(resolve => {
    setTimeout(() => {
      ...
      resolve(
        searchText
          ? teams.filter(team => searchText && team.label.toLowerCase().includes(searchText.toLowerCase()))
          : teams,
      );
    }, 1000);
  });
    ...
    <TextField
      ...
      InputProps={{
        ...
        inputProps: {
          ...
          children: props.children, // valueContainer, buttonGroup
          ...props.innerProps,
        },
      }}
...
function inputComponent({ inputRef, ...props }) {
  return <Paper ref={inputRef} {...props} />;
}

// Placeholder, Input, SingleValue, MultiValue, ... 구성 요소를 래핑
...
// 문자 하이라이트 표시
function ValueLabel({ label, search }) {
