...
function CollectingFormInput() {
  ...
  return (
    <Fragment>
      ...
      <Snackbar open={snackbarOpen} message={snackbarMessage} onClose={onSnackbarClose} autoHideDuration={4000} />
    </Fragment>
  );
}
export default CollectingFormInput;