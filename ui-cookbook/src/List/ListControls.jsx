...
function MaybeBluetoothIcon({ bluetooth }) {
  return bluetooth ? <BluetoothIcon /> : <BluetoothDisabledIcon />;
}
      ...
      {items.map(({ Icon, ...item }, index) => (
        <ListItem key={index} disabled={!item.power} button>
          ...
          <ListItemSecondaryAction>
            <IconButton onClick={onToggleClick(index, 'bluetooth')} disabled={!item.power}>
