...
function NavMenuItem({ color, ...props }) {
  return (
    <Switch>
      <Route exact path={props.to} render={() => <MenuItem selected component={Link} {...props} />} />
      <Route path="/" render={() => <MenuItem component={Link} {...props} />} />
    </Switch>
  );
}

function CustomizingMenuItems() {
...
export default CustomizingMenuItems;
