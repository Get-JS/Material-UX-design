...
function ButtonEmphasis({ disabled, appBarColor }) {
        ...
        <AppBar color={appBarColor}>
          <Toolbar>
            <Grid container spacing={2}>
              <Grid item>
                <Button variant="text" disabled={disabled} color="inherit">
                  Text
                </Button>
              </Grid>
              <Grid item>
                <Button variant="outlined" disabled={disabled} color="inherit">
                  Outlined
                </Button>
              </Grid>
              <Grid item>
                <Button variant="contained" disabled={disabled} color={buttonColor(appBarColor)}>
                  Contained
                </Button>
              </Grid>
            </Grid>
